...
export default function TermsAndConditions() {
  return (
    <Layout>
      ...
      <h1 className="text-2xl text-primary font-bold mb-3 text-center">Terms and Conditions</h1>

      <p>
        Agreement between User and https://www.vimvala.com Welcome to
        https://www.vimvala.com. The https://www.vimvala.com website (the
        "Site") is comprised of various web pages operated by Vimvala LLC
        ("Vimvala"). https://www.vimvala.com is offered to you conditioned on
        your acceptance without modification of the terms, conditions, and
        notices contained herein (the "Terms"). Your use of
        https://www.vimvala.com constitutes your agreement to all such Terms.
        Please read these terms carefully, and keep a copy of them for your
        reference.
      </p>

      <p>https://www.vimvala.com is a Blog and Business Profile Site.</p>

      <p>To provide insights and promote services for Salesforce Consulting.</p>

      <p>
        Electronic Communications Visiting https://www.vimvala.com or sending
        emails to Vimvala constitutes electronic communications. You consent to
      ...
      <p>
        Children Under Thirteen Vimvala does not knowingly collect, either
        online or offline, personal information from persons under the age of
        thirteen. If you are under 18, you may use https://www.vimvala.com only
        with permission of a parent or guardian.
      </p>

      <p>
        Links to Third Party Sites/Third Party Services https://www.vimvala.com
        may contain links to other websites ("Linked Sites"). The Linked Sites
        are not under the control of Vimvala and Vimvala is not responsible for
        ...
        Vimvala is providing these links to you only as a convenience, and the
        inclusion of any link does not imply endorsement by Vimvala of the site
        or any association with its operators.
      </p>

      <p>
        Certain services made available via https://www.vimvala.com are
        delivered by third party sites and organizations. By using any product,
        service or functionality originating from the https://www.vimvala.com
        domain, you hereby acknowledge and consent that Vimvala may share such
        information and data with any third party with whom Vimvala has a
        contractual relationship to provide the requested product, service or
        functionality on behalf of https://www.vimvala.com users and customers.
      </p>
      ...
      <p>
        ...
        https://www.vimvala.com strictly in accordance with these terms of use.
        As a condition of your use of the Site, you warrant to Vimvala that you
        will not use the Site for any purpose that is unlawful or prohibited by
        ...
        party's use and enjoyment of the Site. You may not obtain or attempt to
      ...
      <p>
        ...
        on the Site, is the property of Vimvala or its suppliers and protected
      ...
      <p>
        ...
        of the content, in whole or in part, found on the Site. Vimvala content
        ...
        permission of Vimvala and the copyright owner. You agree that you do not
        ...
        Vimvala or our licensors except as expressly authorized by these Terms.
      </p>

      <p>
        International Users The Service is controlled, operated and administered
        by Vimvala from our offices within the USA. If you access the Service
        from a location outside the USA, you are responsible for compliance with
        all local laws. You agree that you will not use the Vimvala Content
        accessed through https://www.vimvala.com in any country or in any manner
      ...
      <p>
        ...
        Vimvala, its officers, directors, employees, agents and third parties,
        ...
        regulations. Vimvala reserves the right, at its own cost, to assume the
        exclusive defense and control of any matter otherwise subject to
        indemnification by you, in which event you will fully cooperate with
        Vimvala in asserting any available defenses.
      </p>
      ...
      <p>
        ...
        HEREIN. VIMVALA LLC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
        CHANGES IN THE SITE AT ANY TIME.
      </p>
      <p>
        VIMVALA LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
        ...
        ANY KIND. VIMVALA LLC AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL
      ...
      <p>
        ...
        VIMVALA LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
        ...
        OTHERWISE, EVEN IF VIMVALA LLC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED
      ...
      <p>
        Termination/Access Restriction Vimvala reserves the right, in its sole
        ...
        of the State of Utah and you hereby consent to the exclusive
        jurisdiction and venue of courts in Utah in all disputes arising out of
        or relating to the use of the Site. Use of the Site is unauthorized in
      ...
      <p>
        ...
        relationship exists between you and Vimvala as a result of this
        agreement or use of the Site. Vimvala's performance of this agreement is
        subject to existing laws and legal process, and nothing contained in
        this agreement is in derogation of Vimvala's right to comply with
        ...
        by Vimvala with respect to such use. If any part of this agreement is
      ...
      <p>
        ...
        agreement between the user and Vimvala with respect to the Site and it
        supersedes all prior or contemporaneous communications and proposals,
        whether electronic, oral or written, between the user and Vimvala with
      ...
      <p>
        Changes to Terms Vimvala reserves the right, in its sole discretion, to
        change the Terms under which https://www.vimvala.com is offered. The
        most current version of the Terms will supersede all previous versions.
        Vimvala encourages you to periodically review the Terms to stay informed
        of our updates.
      </p>

      <p>
        Contact Us Vimvala welcomes your questions or comments regarding the
        Terms:
      </p>
      <p>Vimvala LLC 755 S. Main Street, Suite 4-146 Cedar City, Utah 84720</p>

      <p>Email Address: jordan@vimvala.com</p>
      <p>Telephone number: 3852085390</p>
        <p>Effective as of February 28, 2025</p>
      </div>
    </Layout>
  )
}
